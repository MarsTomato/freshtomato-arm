...
enum opt_code
{
  ...
  /* OPT_ftail_call_workaround = 996, */     /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 997,          /* -ftail-call-workaround= */
  ...
  OPT_mabi_ = 1153,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1154,             /* -mabort-on-noreturn */
  OPT_mandroid = 1155,                       /* -mandroid */
  OPT_mapcs = 1156,                          /* -mapcs */
  OPT_mapcs_frame = 1157,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1158,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1159,              /* -mapcs-stack-check */
  OPT_march_ = 1160,                         /* -march= */
  OPT_marm = 1161,                           /* -marm */
  OPT_masm_syntax_unified = 1162,            /* -masm-syntax-unified */
  OPT_mbig_endian = 1163,                    /* -mbig-endian */
  OPT_mbionic = 1164,                        /* -mbionic */
  OPT_mcallee_super_interworking = 1165,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1166,     /* -mcaller-super-interworking */
  OPT_mcmse = 1167,                          /* -mcmse */
  OPT_mcpu_ = 1168,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1169,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1170,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1171,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1172,                  /* -mfp16-format= */
  OPT_mfpu_ = 1173,                          /* -mfpu= */
  OPT_mglibc = 1174,                         /* -mglibc */
  /* OPT_mhard_float = 1175, */              /* -mhard-float */
  OPT_mlittle_endian = 1176,                 /* -mlittle-endian */
  OPT_mlong_calls = 1177,                    /* -mlong-calls */
  OPT_mmusl = 1178,                          /* -mmusl */
  OPT_mneon_for_64bits = 1179,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1180,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1181,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1182,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1183,               /* -mprint-tune-info */
  OPT_mpure_code = 1184,                     /* -mpure-code */
  OPT_mrestrict_it = 1185,                   /* -mrestrict-it */
  OPT_msched_prolog = 1186,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1187,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1188,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1189, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1190,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1191,                         /* -mthumb */
  OPT_mthumb_interwork = 1192,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1193,                  /* -mtls-dialect= */
  OPT_mtp_ = 1194,                           /* -mtp= */
  OPT_mtpcs_frame = 1195,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1196,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1197,                         /* -mtune= */
  OPT_muclibc = 1198,                        /* -muclibc */
  OPT_munaligned_access = 1199,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1200,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1201,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1202,              /* -mword-relocations */
  OPT_n = 1203,                              /* -n */
  OPT_no_canonical_prefixes = 1204,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1205,              /* -no-integrated-cpp */
  OPT_no_pie = 1206,                         /* -no-pie */
  OPT_nocpp = 1207,                          /* -nocpp */
  OPT_nodefaultlibs = 1208,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1209,                   /* -nostartfiles */
  OPT_nostdinc = 1210,                       /* -nostdinc */
  OPT_nostdinc__ = 1211,                     /* -nostdinc++ */
  OPT_nostdlib = 1212,                       /* -nostdlib */
  OPT_o = 1213,                              /* -o */
  OPT_p = 1214,                              /* -p */
  OPT_pass_exit_codes = 1215,                /* -pass-exit-codes */
  /* OPT_pedantic = 1216, */                 /* -pedantic */
  OPT_pedantic_errors = 1217,                /* -pedantic-errors */
  OPT_pg = 1218,                             /* -pg */
  OPT_pie = 1219,                            /* -pie */
  OPT_pipe = 1220,                           /* -pipe */
  OPT_posix = 1221,                          /* -posix */
  OPT_print_file_name_ = 1222,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1223,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1224,          /* -print-multi-directory */
  OPT_print_multi_lib = 1225,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1226,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1227,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1228,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1229,               /* -print-prog-name= */
  OPT_print_search_dirs = 1230,              /* -print-search-dirs */
  OPT_print_sysroot = 1231,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1232,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1233,                        /* -profile */
  OPT_pthread = 1234,                        /* -pthread */
  OPT_quiet = 1235,                          /* -quiet */
  OPT_r = 1236,                              /* -r */
  OPT_rdynamic = 1237,                       /* -rdynamic */
  OPT_remap = 1238,                          /* -remap */
  OPT_s = 1239,                              /* -s */
  ...
  OPT_static_libgfortran = 1249,             /* -static-libgfortran */
  OPT_static_libgo = 1250,                   /* -static-libgo */
  OPT_static_liblsan = 1251,                 /* -static-liblsan */
  OPT_static_libmpx = 1252,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1253,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1254,               /* -static-libstdc++ */
  OPT_static_libtsan = 1255,                 /* -static-libtsan */
  OPT_static_libubsan = 1256,                /* -static-libubsan */
  /* OPT_std_c__03 = 1257, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1258, */                /* -std=c++0x */
  OPT_std_c__11 = 1259,                      /* -std=c++11 */
  OPT_std_c__14 = 1260,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1261, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1262, */                /* -std=c++1y */
  OPT_std_c__1z = 1263,                      /* -std=c++1z */
  OPT_std_c__98 = 1264,                      /* -std=c++98 */
  OPT_std_c11 = 1265,                        /* -std=c11 */
  /* OPT_std_c1x = 1266, */                  /* -std=c1x */
  /* OPT_std_c89 = 1267, */                  /* -std=c89 */
  OPT_std_c90 = 1268,                        /* -std=c90 */
  OPT_std_c99 = 1269,                        /* -std=c99 */
  /* OPT_std_c9x = 1270, */                  /* -std=c9x */
  OPT_std_f2003 = 1271,                      /* -std=f2003 */
  OPT_std_f2008 = 1272,                      /* -std=f2008 */
  OPT_std_f2008ts = 1273,                    /* -std=f2008ts */
  OPT_std_f95 = 1274,                        /* -std=f95 */
  OPT_std_gnu = 1275,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1276, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1277, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1278,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1279,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1280, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1281, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1282,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1283,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1284,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1285, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1286, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1287,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1288,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1289, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1290, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1291,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1292, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1293, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1294, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1295,                     /* -std=legacy */
  OPT_symbolic = 1296,                       /* -symbolic */
  OPT_t = 1297,                              /* -t */
  OPT_time = 1298,                           /* -time */
  OPT_time_ = 1299,                          /* -time= */
  OPT_tno_android_cc = 1300,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1301,                 /* -tno-android-ld */
  OPT_traditional = 1302,                    /* -traditional */
  OPT_traditional_cpp = 1303,                /* -traditional-cpp */
  OPT_trigraphs = 1304,                      /* -trigraphs */
  OPT_u = 1305,                              /* -u */
  OPT_undef = 1306,                          /* -undef */
  OPT_v = 1307,                              /* -v */
  OPT_version = 1308,                        /* -version */
  OPT_w = 1309,                              /* -w */
  OPT_wrapper = 1310,                        /* -wrapper */
  OPT_x = 1311,                              /* -x */
  OPT_z = 1312,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
