...
<div class="section">
<!-- CTF-BEGIN -->
	<div class="fields" id="ctfnotice" style="display:none"><div class="about"><p style="color: red;"><b><a href="advanced-misc.asp">CTF</a> is currently enabled, this prevents QoS from functioning.</b></div></div>
<!-- CTF-END -->
<!-- BCMNAT-BEGIN -->
	<div class="fields" id="bcmnatnotice" style="display:none"><div class="about"><p style="color: red;"><b><a href="advanced-misc.asp">FastNAT</a> is currently enabled this prevents QoS from functioning.</b></div></div>
<!-- BCMNAT-END -->
